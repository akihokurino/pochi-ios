...
class SitterProfileDataSource: NSObject, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        case .ProfileData:
            return 1
        case .DogData:
            return SitterProfileDataSource.EACH_DOG_DISPLAY_ITEM_NUM * userDogs.count
        case .ReviewData:
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .ProfileData:
            ...
            cell.bind(user: sitter)
            return cell
        case .DogData:
            let currentIndex = indexPath.row % SitterProfileDataSource.EACH_DOG_DISPLAY_ITEM_NUM
            let currentDog = userDogs[indexPath.row / SitterProfileDataSource.EACH_DOG_DISPLAY_ITEM_NUM]
            switch currentIndex {
            case 0:
...
extension SitterProfileDataSource: UITableViewDelegate {
