//
//  LeaveBookingListViewController.swift
//  pochi
//
...
// ユーザーとして預ける
class LeaveBookingListViewController: UIViewController {
    ...
    private let viewModel: LeaveBookingListViewModel = LeaveBookingListViewModel()
    ...
    private func observeSegmentedControl() {
        segmentedControl.rx.value
            ...
            .drive(onNext: { value in
                self.tableView.tableFooterView?.isHidden = false
                self.tableView.backgroundView?.isHidden = true
                self.viewModel.currentSegment = LeaveBookingListViewModel.Segment(rawValue: value)!
    ...
    private func toMessageViewController(booking: Booking) {
