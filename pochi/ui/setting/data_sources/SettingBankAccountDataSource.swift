//
//  SettingBankAccountDataSource.swift
//  pochi
//
...
class SettingBankAccountDataSource: NSObject, UITableViewDataSource, RxTableViewDataSourceType {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        return tableDelegate.generateSectionHeader(section: section, title: "登録済み銀行口座")
    }
...
extension SettingBankAccountDataSource: UITableViewDelegate {
