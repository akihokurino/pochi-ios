//
//  ClosedKeepBookingListViewController.swift
//  pochi
//
...
class ClosedKeepBookingListViewController: UIViewController {
    
    @IBOutlet weak var tableView: UITableView!

    private let disposeBag: DisposeBag = DisposeBag()
    private var dataSource: ClosedKeepBookingListDataSource!
    private let viewModel: ClosedKeepBookingListViewModel = ClosedKeepBookingListViewModel()
    ...
    private func setupTableView() {
        dataSource = ClosedKeepBookingListDataSource(tableView: tableView)
        let emptyView = EmptyView.instance()
        emptyView.bind(data: EmptyView.DisplayData(message: "終了した受け入れはありません"))
